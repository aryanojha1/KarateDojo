    ...
    <section className='gallery' id='gallery' ref={galleryRef}>
      <div className='container'>
        ...
        <p className='gallery-subtitle' ref={subtitleRef}>
          Experience the power and discipline of Karate Dojo through our photo
          gallery
        </p>
          ...
          <div className='box box-one' ref={gallery1}>
            ...
            <div className='box-overlay'>
              <div className='details'>
                ...
                <p>Karate Dojo student practicing kicks</p>
              </div>
            </div>
          </div>
          ...
          <div className='box box-four' ref={gallery4}>
            ...
            <div className='box-overlay'>
              <div className='details'>
                ...
                <p>Karate Dojo students learning self-defense techniques</p>
              </div>
            </div>
          </div>
          ...
          <div className='box box-six' ref={gallery6}>
            ...
            <div className='box-overlay'>
              <div className='details'>
                ...
                <p>Karate Dojo students competing in tournaments</p>
              </div>
            </div>
          </div>
        </div>
